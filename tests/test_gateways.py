    ...
    def test_gateway(self, client):
        ...
        for code in ["654321", "054321", "87654321", "07654321"]:
            ...
            client.return_value.calls.create.assert_called_with(
                ...
                method="GET",
                timeout=15,
                url="http://testserver/twilio/inbound/two_factor/%s/?locale=en-us"
                % code,
            )
            ...
            client.return_value.messages.create.assert_called_with(
                ...
                body=render_to_string(
                    "two_factor/twilio/sms_message.html", {"token": code}
                ),
                from_="+456",
            )
            ...
            with translation.override("en-gb"):
                ...
                client.return_value.calls.create.assert_called_with(
                    ...
                    method="GET",
                    timeout=15,
                    url="http://testserver/twilio/inbound/two_factor/%s/?locale=en-gb"
                    % code,
                )
